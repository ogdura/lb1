...
<div class="container-fluid">
    <div class="row">
        <div class="img-wrap">
            <img class="img-responsive w-100" src="f74SgD6L0Mg.jpg" alt="">
            <h1 class="text-danger m-auto text-center"> НУЖЕН ДАБСТЕБ?</h1>
        </div>
        bu
    </div>
</div>
<div class="cointainer">
    <div class="row">
        <div class="col-md-8">
            <img class="w-100" src="5e5fbbf8e3ee2.jpg" alt="">
        </div>
        <div class="col-md-4">
            <h1>Лучшиая дабстеп-музка</h1>
            <p>
                С нами работают исключительно профессионалы, которые разбираются в синтезе и диджеинге.
            </p>
        </div>
    </div>
</div>
<footer class="container-fluid bg-dark">
    ...
    <p class="text-white">2023 Omsk Russia from Sebiriat</p>
